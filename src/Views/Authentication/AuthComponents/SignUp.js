        ...
        <div className="flex w-full h-full justify-center flex-col gap-3">
            <div className="w-full">
                ...
                <div className="w-2/5 mx-auto flex justify-around">
                    ...
                    <FontAwesomeIcon className="w-8 h-8" icon={faGit}/>
                    <FontAwesomeIcon className="w-8 h-8" icon={faGoogle}/>
                </div>
            ...
            <div className="w-4/5 mx-auto flex flex-col gap-4">
                <div className="relative flex w-full">
                    <div className="w-12 h-12 flex justify-center items-center bg-[#c5c5c5] rounded-l-lg">
                        <svg  className="w-7 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path fill="rgb(255,254,236)" d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/>
                        </svg>
                    </div>
                    <input name="name" onChange={setUsersCredentials} onKeyUp={handleEnterSignup} className="text-fields w-full outline-none h-12 border rounded-r-lg border-l-0 px-2 bg-transparent z-10" />
                ...
                <div className="relative flex w-full">
                    ...
                    <input type="email" name="email" onChange={setUsersCredentials} onKeyUp={handleEnterSignup} className="text-fields w-full outline-none h-12 border rounded-r-lg px-2 border-l-0 bg-transparent z-10"/>
                ...
                <div className="relative flex w-full">
                    ...
                    <input type="password" name="password" onChange={setUsersCredentials} onKeyUp={handleEnterSignup} className="text-fields w-full outline-none h-12 border rounded-r-lg px-2 border-l-0 bg-transparent z-10"/>
                ...
                <div className="relative flex w-full">
                    ...
                    <input type="password" name="confirmPassword" onChange={setUsersCredentials} onKeyUp={handleEnterSignup} className="text-fields w-full outline-none h-12 border rounded-r-lg px-2 border-l-0 bg-transparent z-10"/>
                    <h2 className="absolute top-1/4 left-14 text-[#999]">Confirm Password</h2>
                </div>
                <div className="text-center">
                    <button onClick={register} className="w-36 h-10 text-xl font-bold rounded-3xl text-white bg-primary hover:bg-[#465abe] transition-all duration-500 ease-linear">Register</button>
                </div>
            </div>
        </div>
    )
