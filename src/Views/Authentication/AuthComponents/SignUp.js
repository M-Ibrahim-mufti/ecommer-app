        ...
        <div className="flex w-full h-full justify-center flex-col gap-3">
            ...
            <div className="w-4/5 mx-auto flex flex-col gap-4">
                ...
                <div className="text-center">
                    <button onClick={register} className="w-36 h-10 text-xl font-bold rounded-3xl text-white bg-[rgba(86,112,235,1)] hover:bg-[#465abe] transition-all duration-500 ease-linear">Register</button>
                </div>
            </div>
        </div>
    )
